...
class TradeCurrency(Auditable):
	...
	type_currncy = models.IntegerField(choices=type_currency,default=0,verbose_name='Type Currncy')
	chain_id=models.IntegerField(verbose_name='Chain ID',default=97)
